...
InstancingStandardShader::InstancingStandardShader()
{
}
...
D3D12_INPUT_LAYOUT_DESC InstancingStandardShader::CreateInputLayout()
{
...
D3D12_RASTERIZER_DESC InstancingStandardShader::CreateRasterizerState()
{
...
D3D12_BLEND_DESC InstancingStandardShader::CreateBlendState()
{
...
D3D12_DEPTH_STENCIL_DESC InstancingStandardShader::CreateDepthStencilState()
{
...
D3D12_PRIMITIVE_TOPOLOGY_TYPE InstancingStandardShader::CreatePrimitiveTopologyType()
{
	return D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE;
}

D3D12_SHADER_BYTECODE InstancingStandardShader::CreateVertexShader(ID3DBlob ** ppd3dShaderBlob)
{
	return Shader::CompileShaderFromFile(L"StandardShader.hlsl", "VSStandardInstancing", "vs_5_1", ppd3dShaderBlob);
}
