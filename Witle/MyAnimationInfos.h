...
const ANIMATION_INFO BOSS_IDLE{ 0, 0.f * SECOND_PER_FRAME,   30.f * SECOND_PER_FRAME }; // 기본
const ANIMATION_INFO BOSS_MOVE{ 1, 31.f * SECOND_PER_FRAME,   61.f * SECOND_PER_FRAME }; // 이동
const ANIMATION_INFO BOSS_CHASE{ 2, 62.f * SECOND_PER_FRAME,   82.f * SECOND_PER_FRAME }; // 추격
