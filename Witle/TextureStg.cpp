...
#include "TextureStg.h"

TextureStg* TextureStg::m_Instance{ nullptr };

TextureStg::TextureStg()
{
...
void TextureStg::CreateTexture(const std::string & name, ID3D12Device * pd3dDevice, ID3D12GraphicsCommandList * pd3dCommandList, int heapindex)
{
...
void TextureStg::ReleaseUploadBuffers()
{
...
void TextureStg::ReleaseObjects()
{
	if (m_Heap)
	{
...
void TextureStg::CreateTextures(ID3D12Device * pd3dDevice, ID3D12GraphicsCommandList * pd3dCommandList)
{
...
Texture * const TextureStg::GetTexture(const std::string & name)
{
	if (m_TextureStorage.find(name) == m_TextureStorage.end()) return nullptr;
	return m_TextureStorage[name];
}

void TextureStg::SetHeap(ID3D12GraphicsCommandList * pd3dCommandList)
{
