...
void PlayerLeftWalkAction::UpdateVelocity(float fElpasedTime, PlayerMovement * movement)
{
...
void PlayerLeftWalkAction::UpdateState(float fElpasedTime, PlayerActionMgr * actionMgr)
{
