...
void PlayerForwardWalkAction::UpdateVelocity(float fElpasedTime, PlayerMovement * movement)
{
...
void PlayerForwardWalkAction::UpdateState(float fElpasedTime, PlayerActionMgr * actionMgr)
{
