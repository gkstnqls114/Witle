...
void PlayerIdleAction::UpdateVelocity(float fElpasedTime, PlayerMovement * movement)
{
...
void PlayerIdleAction::UpdateState(float fElpasedTime, PlayerActionMgr * actionMgr)
{
