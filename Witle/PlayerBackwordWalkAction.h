...
class PlayerBackwordWalkAction
	: public PlayerAction
{
...
public:
	PlayerBackwordWalkAction(GameObject* pOwner, float idleTime) : PlayerAction(pOwner), m_IdleTime(idleTime) { };
	virtual ~PlayerBackwordWalkAction() {};
