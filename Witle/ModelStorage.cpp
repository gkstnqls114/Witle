...
void ModelStorage::CreateModels(ID3D12Device * pd3dDevice, ID3D12GraphicsCommandList * pd3dCommandList, ID3D12RootSignature * pd3dGraphicsRootSignature)
{
	...
	m_ModelStorage[TREE_BG_3].modelBOBox = new MyBOBox(test, pd3dDevice, pd3dCommandList, XMFLOAT3{0.F, 0.F, 0.F},XMFLOAT3{ 200.F/ 2.f, 200.F/ 2.f, 200.F/ 2.f });
	m_ModelStorage[RUIN_ARCH].modelBOBox = new MyBOBox(test, pd3dDevice, pd3dCommandList, XMFLOAT3{ 0.F, 0.F, 0.F }, XMFLOAT3{ 300.F / 2.f, 300.F / 2.f, 300.F / 2.f });
	m_ModelStorage[RUIN_BROKENPILLA].modelBOBox = new MyBOBox(test, pd3dDevice, pd3dCommandList, XMFLOAT3{ 0.F, 0.F, 0.F }, XMFLOAT3{ 300.F / 2.f, 300.F/ 2.f, 300.F/ 2.f });
	m_ModelStorage[RUIN_PILLAR].modelBOBox = new MyBOBox(test, pd3dDevice, pd3dCommandList, XMFLOAT3{ 0.F, 0.F, 0.F }, XMFLOAT3{ 400.F/ 2.f, 400.F/ 2.f, 400.F/ 2.f });
	m_ModelStorage[RUIN_SQUARE].modelBOBox = new MyBOBox(test, pd3dDevice, pd3dCommandList, XMFLOAT3{ 0.F, 0.F, 0.F }, XMFLOAT3{ 400.F/ 2.f, 400.F/ 2.f, 400.F/ 2.f });
