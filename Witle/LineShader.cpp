...
D3D12_INPUT_LAYOUT_DESC LineShader::CreateInputLayout()
{
...
D3D12_RASTERIZER_DESC LineShader::CreateRasterizerState()
{
...
D3D12_BLEND_DESC LineShader::CreateBlendState()
{
...
D3D12_DEPTH_STENCIL_DESC LineShader::CreateDepthStencilState()
{
...
D3D12_PRIMITIVE_TOPOLOGY_TYPE LineShader::CreatePrimitiveTopologyType()
{
	return D3D12_PRIMITIVE_TOPOLOGY_TYPE_LINE;
}

D3D12_SHADER_BYTECODE LineShader::CreateVertexShader(ID3DBlob ** ppd3dShaderBlob)
{
	return Shader::CompileShaderFromFile(L"LineShader.hlsl", "VS", "vs_5_1", ppd3dShaderBlob);
}
