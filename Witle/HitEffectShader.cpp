...
D3D12_SHADER_BYTECODE HitEffectShader::CreateGeometryShader(ID3DBlob ** ppd3dShaderBlob)
{
	return D3D12_SHADER_BYTECODE();
}

HitEffectShader::HitEffectShader()
{
}
...
void HitEffectShader::CreateShader(ID3D12Device * pd3dDevice, ID3D12RootSignature * const pd3dGraphicsRootSignature)
{
...
void HitEffectShader::Update(float ElapsedTime)
{
}

D3D12_INPUT_LAYOUT_DESC HitEffectShader::CreateInputLayout()
{
...
D3D12_RASTERIZER_DESC HitEffectShader::CreateRasterizerState()
{
	//래스터라이저 상태를 설정한다.
...
D3D12_BLEND_DESC HitEffectShader::CreateBlendState()
{
...
D3D12_DEPTH_STENCIL_DESC HitEffectShader::CreateDepthStencilState()
{
...
D3D12_PRIMITIVE_TOPOLOGY_TYPE HitEffectShader::CreatePrimitiveTopologyType()
{
