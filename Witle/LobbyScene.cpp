...
ID3D12RootSignature* LobbyScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pRootParameters[ROOTPARAMETER_PICKINGPOINT] = d3dUtil::CreateRootParameterConstants(3, 4);  // b4: Color
