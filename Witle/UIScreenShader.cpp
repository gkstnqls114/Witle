...
D3D12_SHADER_BYTECODE UIScreenShader::CreateGeometryShader(ID3DBlob ** ppd3dShaderBlob)
{
...
D3D12_RASTERIZER_DESC UIScreenShader::CreateRasterizerState()
{
	//래스터라이저 상태를 설정한다.
...
D3D12_BLEND_DESC UIScreenShader::CreateBlendState()
{
...
D3D12_DEPTH_STENCIL_DESC UIScreenShader::CreateDepthStencilState()
{
...
D3D12_PRIMITIVE_TOPOLOGY_TYPE UIScreenShader::CreatePrimitiveTopologyType()
{
